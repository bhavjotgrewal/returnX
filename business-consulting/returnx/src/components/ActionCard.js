      ...
      <div className="flex flex-col md:flex-row flex-wrap">
        ...
        <div className="p-6 md:w-2/3 flex flex-col">
          <div className="flex items-center mb-3">
            <div className="bg-google-blue bg-opacity-10 text-google-blue h-8 w-8 rounded-full flex items-center justify-center font-medium mr-3">
              {number}
            </div>
          ...
          <div className="mt-6 flex justify-end">
            <button className="google-button px-4 py-2 rounded-md font-medium flex items-center">
